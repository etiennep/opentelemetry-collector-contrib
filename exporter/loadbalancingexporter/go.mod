...
require (
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/batchpersignal v0.87.0
...
require (
	...
	go.opentelemetry.io/collector/config/configgrpc v0.87.1-0.20231023033326-37116a25be8d // indirect
	...
	go.opentelemetry.io/collector/processor v0.87.1-0.20231023033326-37116a25be8d // indirect
	go.opentelemetry.io/collector/receiver v0.87.1-0.20231023033326-37116a25be8d // indirect
	go.opentelemetry.io/collector/service v0.87.1-0.20231017160804-ec0725874313 // indirect
